...
# def augmentation_pipeline(images, box_lists,
#                           random_geometry=True,
#                           random_color=True):
...
#         bbox_lists.append(BoundingBoxesOnImage(bbox_list, shape=(h,w,c)))

#     aug_images, aug_bbox_lists = seq(
#         images=images, bounding_boxes=bbox_lists)

#     aug_box_lists = []
#     for aug_bbox_list in aug_bbox_lists:
#         aug_box_list = []
#         for bbox in aug_bbox_list:
#             x1 = bbox.x1 / w
#             y1 = bbox.y1 / h
...
#             y2 = bbox.y2 / h
#             aug_box_list.append([y1,x1,y2,x2])
#         aug_box_lists.append(aug_box_list)
    
#     aug_box_lists = np.array(aug_box_lists, np.float32)
    
#     print('aug_images_shape', aug_images.shape)
#     print('aug_box_lists_shape', aug_box_lists.shape)

#     return aug_images.astype(np.float32), aug_box_lists